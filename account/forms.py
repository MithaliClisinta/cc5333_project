...
from appointment.models import symptoms
...
class PatientRegistrationForm(UserCreationForm):
    ...
    class Meta:
        ...
        fields = ['first_name', 'last_name', 'username', 'email', 'phone_number', 'password1', 'password2', 'gender' ]
        error_messages = {
            'first_name': {
...
class symptomsUpdateForm(forms.ModelForm):

    def __init__(self, *args, **kwargs):
        super(symptomsUpdateForm, self).__init__(*args, **kwargs)
